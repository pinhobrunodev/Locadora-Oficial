...
@WebServlet(urlPatterns = {"/acessoAdmin/delete"})
public class RemoverVeiculoController extends HttpServlet{
	...
	protected void process(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(path.equals("/acessoAdmin/delete")) {
			removerVeiculo(req, resp);
		}
	}
	...
	protected void removerVeiculo(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		veiculoBeans.setId(Integer.parseInt(req.getParameter("id")));
		veiculoDAO.removerVeiculo(veiculoBeans);
